...
namespace BestPractices.BestPractices
{
    public class _06Example
    {
        ...
        /*
        * MALA PRACTICA = MALA GESTION DE ACCESIBILIDAD
        */
        public void EnviarCorreo(string asunto, string cargoDestinatario, string destinatario)
        {
            try
            {
                string formatoCorreo = ObtenerFormatoDeCorreoPorCargo(cargoDestinatario);
        ...
        public string ObtenerFormatoDeCorreoPorCargo(string cargoDestinatario) {
